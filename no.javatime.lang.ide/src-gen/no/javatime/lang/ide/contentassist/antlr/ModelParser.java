 ...
 */
package no.javatime.lang.ide.contentassist.antlr;

import com.google.inject.Inject;
import java.util.Collection;
import java.util.HashMap;
import java.util.Map;
import no.javatime.lang.ide.contentassist.antlr.internal.InternalModelParser;
...
public class ModelParser extends AbstractContentAssistParser {
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelElementTypeNameAccess().getAlternatives(), "rule__ModelElementTypeName__Alternatives");
					put(grammarAccess.getFieldTypeNameAccess().getAlternatives(), "rule__FieldTypeName__Alternatives");
					put(grammarAccess.getOperationTypeNameAccess().getAlternatives(), "rule__OperationTypeName__Alternatives");
					put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
					put(grammarAccess.getPackageDeclarationAccess().getGroup(), "rule__PackageDeclaration__Group__0");
					put(grammarAccess.getModelElementTypeAccess().getGroup(), "rule__ModelElementType__Group__0");
					put(grammarAccess.getModelElementTypeAccess().getGroup_3(), "rule__ModelElementType__Group_3__0");
					put(grammarAccess.getModelElementTypeAccess().getGroup_4(), "rule__ModelElementType__Group_4__0");
					put(grammarAccess.getModelElementTypeAccess().getGroup_4_2(), "rule__ModelElementType__Group_4_2__0");
					...
					put(grammarAccess.getPackageDeclarationAccess().getImportSectionAssignment_0(), "rule__PackageDeclaration__ImportSectionAssignment_0");
					put(grammarAccess.getPackageDeclarationAccess().getNameAssignment_2(), "rule__PackageDeclaration__NameAssignment_2");
					put(grammarAccess.getPackageDeclarationAccess().getPackageElementsAssignment_4(), "rule__PackageDeclaration__PackageElementsAssignment_4");
					put(grammarAccess.getModelElementTypeAccess().getTypeNameAssignment_0(), "rule__ModelElementType__TypeNameAssignment_0");
					put(grammarAccess.getModelElementTypeAccess().getModelElementAnnotationsAssignment_1(), "rule__ModelElementType__ModelElementAnnotationsAssignment_1");
					put(grammarAccess.getModelElementTypeAccess().getNameAssignment_2(), "rule__ModelElementType__NameAssignment_2");
					put(grammarAccess.getModelElementTypeAccess().getSuperTypeAssignment_3_1(), "rule__ModelElementType__SuperTypeAssignment_3_1");
					put(grammarAccess.getModelElementTypeAccess().getImplementsAssignment_4_1(), "rule__ModelElementType__ImplementsAssignment_4_1");
					put(grammarAccess.getModelElementTypeAccess().getImplementsAssignment_4_2_1(), "rule__ModelElementType__ImplementsAssignment_4_2_1");
					put(grammarAccess.getModelElementTypeAccess().getMembersAssignment_6(), "rule__ModelElementType__MembersAssignment_6");
					put(grammarAccess.getFieldAccess().getTypeNameAssignment_0(), "rule__Field__TypeNameAssignment_0");
					put(grammarAccess.getFieldAccess().getFieldAnnotationsAssignment_1(), "rule__Field__FieldAnnotationsAssignment_1");
					put(grammarAccess.getFieldAccess().getMemberTypeAssignment_2(), "rule__Field__MemberTypeAssignment_2");
					put(grammarAccess.getFieldAccess().getNameAssignment_3(), "rule__Field__NameAssignment_3");
					put(grammarAccess.getFieldAccess().getInitExpAssignment_4_1(), "rule__Field__InitExpAssignment_4_1");
					put(grammarAccess.getOperationAccess().getTypeNameAssignment_0(), "rule__Operation__TypeNameAssignment_0");
					put(grammarAccess.getOperationAccess().getOperationAnnotationsAssignment_1(), "rule__Operation__OperationAnnotationsAssignment_1");
					put(grammarAccess.getOperationAccess().getMemberTypeAssignment_2(), "rule__Operation__MemberTypeAssignment_2");
					put(grammarAccess.getOperationAccess().getNameAssignment_3(), "rule__Operation__NameAssignment_3");
					put(grammarAccess.getOperationAccess().getFormalParametersAssignment_5_0(), "rule__Operation__FormalParametersAssignment_5_0");
					put(grammarAccess.getOperationAccess().getFormalParametersAssignment_5_1_1(), "rule__Operation__FormalParametersAssignment_5_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalModelParser typedParser = (InternalModelParser) parser;
