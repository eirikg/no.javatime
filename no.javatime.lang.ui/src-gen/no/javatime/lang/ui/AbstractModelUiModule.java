...
import no.javatime.lang.ide.contentassist.antlr.ModelParser;
import no.javatime.lang.ide.contentassist.antlr.PartialModelContentAssistParser;
import no.javatime.lang.ide.contentassist.antlr.internal.InternalModelLexer;
import no.javatime.lang.ui.contentassist.ModelProposalProvider;
import no.javatime.lang.ui.labeling.ModelDescriptionLabelProvider;
import no.javatime.lang.ui.labeling.ModelLabelProvider;
import no.javatime.lang.ui.outline.ModelOutlineTreeProvider;
import no.javatime.lang.ui.quickfix.ModelQuickfixProvider;
...
/**
 * Manual modifications go to {@link ModelUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractModelUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractModelUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(no.javatime.lang.parser.antlr.internal.InternalModelLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalModelLexer.class).toProvider(LexerProvider.create(InternalModelLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ModelLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ModelDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ModelOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ModelQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ModelProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialModelContentAssistParser.class;
	}
